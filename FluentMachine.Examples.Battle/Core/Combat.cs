...
public sealed class Combat
{
    ...
    public CombatResult Result { get; private set; } = null!;
    ...
    public Combat(Combatants combatants, double timeout)
    {
        ...
        _machine = new StateMachineBuilder()
            ...
            .State(TurnStart)
                ...
                .Update((s, _) =>
                {
                    if (_combatants.IsReady || _timeout)
            ...
            .State(CombatCheckStatus)
                .Enter(s => s.Parent.ChangeState(_combatants.IsAnyDead ? CombatEnd : CombatContinue))
            .End()
    ...
    public void Start() => _machine.ChangeState(CombatStart);

    public void Update(float timeDelta) => _machine.Update(timeDelta);
